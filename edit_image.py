...
def random_parameters() -> Tuple[str, Tuple[float, float]]:
    ...
    if pos_neg == "positive":
        changeVal = (
            parameter_range[change]["default"],
            random.choice(
                [val for val in parameter_range[change]["range"] if val > parameter_range[change]["default"]]
            ),
        )
        ...
        ) or (changeVal[0] > parameter_range[change]["default"] and changeVal[1] < parameter_range[change]["default"]):
